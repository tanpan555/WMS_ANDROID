...
class _CardTestState extends State<CardTest> {
  ...
  void filterData() {
    setState(() {
      displayedData = data.where((item) {
        ...
        final matchesApCode =
            selectedApCode == 'ทั้งหมด' || apCode == selectedApCode;
        // final matchesWarehouse =
        //     selectedwhCode == null || warehouse == selectedwhCode;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
          AppBar(title: Text('CARD PAGE'), automaticallyImplyLeading: false),
      body: isLoading
                    ...
                    Padding(
                        ...
                        child: DropdownButton<String>(
                          ...
                          hint: Text('ประเภทรายการ'),
                           items: <String>['รายการรอรับดำเนินการ', 'รายการใบสั่งซื้อ', 'ทั้งหมด'].map((String value) {
                            return DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                            );
      ...
      fixedValue = valueMapping[_selectedValue] ?? '';
        ...
        print('Fixed value: $fixedValue');
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text(
                        'รายการทั้งหมด: ${displayedData.length}',
                        style: TextStyle(

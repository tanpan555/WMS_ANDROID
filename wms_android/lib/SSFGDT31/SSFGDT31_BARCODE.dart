...
Future<void> sendPostRequest() async {
    final url = 'http://172.16.0.82:8888/apex/wms/SSFGDT31/receive_addLine_detail';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          print('p_erp_ou_code : $p_erp_ou_code Type : ${p_erp_ou_code.runtimeType}');
           print('p_doc_no_post : $p_doc_no_post Type : ${p_doc_no_post.runtimeType}');
...
late final TextEditingController Cur_loc_code = TextEditingController(text: LCBARCODE);
            ...
            Padding(
              ...
              child: Column(
                children: [
                    ...
                    GestureDetector(
                    onTap: _openLocatorDialog,  // Open the dialog when tapping the LOC_IN field
                    child: AbsorbPointer(
                      child: _buildTextField(LOC_IN, 'Locator รับ', readOnly: false),
                    ),
                  ),
                  _buildTextField(ITEM_CODE, 'Item Code', readOnly: true),
                  _buildTextField(LOT_NUMBER, 'Lot Number', readOnly: false),
                  _buildTextField(Quantity, 'Quantity', readOnly: false),
                  GestureDetector(
                    onTap: _openCurrLocatorDialog, 
                    child: AbsorbPointer(
                      child: _buildTextField(CUR_LOC, 'Current Locator', readOnly: false),
                    ),
                  ),
